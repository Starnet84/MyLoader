...
public class TimerActivity extends Activity implements LoaderCallbacks<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bndl.putString(TimerLoader.ARGS_TIME_FORMAT, getTimeFormat());
    ...
    public Loader<String> onCreateLoader(int id, Bundle args) {
        ...
        if (id == LOADER_TIME_ID) {
            loader = new TimerLoader(this, args);
    ...
    String getTimeFormat() {
        String result = TimerLoader.TIME_FORMAT_SHORT;
        switch (rgTimeFormat.getCheckedRadioButtonId()) {
            case R.id.rdShort:
                result = TimerLoader.TIME_FORMAT_SHORT;
                break;
            case R.id.rdLong:
                result = TimerLoader.TIME_FORMAT_LONG;
                break;
        }
        return result;
    }
