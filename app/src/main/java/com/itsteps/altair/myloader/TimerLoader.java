...
public class TimerLoader extends Loader<String> {
    ...
    public TimerLoader(Context context, Bundle args) {
        super(context);
    ...
    class GetTimeTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            Log.d(LOG_TAG, TimerLoader.this.hashCode() + " doInBackground");
            try {
        ...
        protected void onPostExecute(String result) {
            ...
            Log.d(LOG_TAG, TimerLoader.this.hashCode() + " onPostExecute "
                    + result);
